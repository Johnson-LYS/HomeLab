...
| 别名 | 设备 | 地址 | 用户 | 端口 | 状态 |
|---|---|---|---|---|---|
| `n100` | 联想百应 NUC · Debian | 192.168.8.15 | `johnson` | 22 | ✓ ssh config |
| `jonas` | QNAP TS-264C | 192.168.8.10 | `Johnson`（大写 J） | 22 | ✓ ssh config（亦 `jonas.jsho.top`） |
| — | 极摩客 · PVE | 192.168.8.16 | ⚠ 待确认（疑 root） | 22 | known_hosts 有，无别名 |
