...
| dashboard-ha | :18081 | 墙面 iPad Home Assistant Web/PWA 控制面；容器 `dashboard-ha`；镜像 `dashboard-ha:20260801-211049`；Compose `/opt/1panel/docker/compose/dashboard-ha/compose.yaml`；仅内网直连，尚未配置 NPM/DNS |
